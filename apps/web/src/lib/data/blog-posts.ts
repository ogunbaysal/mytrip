...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    id: "mavi-yolculuk-servisi",
    slug: "mavi-yolculuk-servisi",
    title: "Mavi yolculuk için bilmeniz gereken her şey",
    excerpt:
      "Gulet seçimi, rotalar, tekne ekibi ve bavul hazırlığı dahil MyTrip editörlerinin hazırladığı kapsamlı rehber.",
    coverImage:
