...
export default function CheckoutPage() {
  ...
  const validateForm = () => {
    ...
    if (paymentData.cardNumber.length < 16) {
      newErrors.cardNumber = "Kart numarası en az 16 haneli olmalıdır";
    }
    ...
    if (!agreed) {
      newErrors.agreed = "Şartları kabul etmeniz gerekmektedir";
    }
    ...
    return (
      <div className="container mx-auto flex min-h-[calc(100vh-8rem)] items-center justify-center px-4 py-12">
        <Card className="mx-auto max-w-md p-8 text-center">
          ...
          <h2 className="mb-2 text-2xl font-bold">Plan Bulunamadı</h2>
          <p className="mb-6 text-muted-foreground">
            Seçilen plan bulunamadı. Lütfen pricing sayfasına gidip tekrar
            deneyiniz.
          </p>
    ...
    <div className="container mx-auto px-4 py-12 md:px-6">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <Card className="p-6">
            <h2 className="mb-6 text-xl font-semibold">Sipariş Özeti</h2>
            ...
            <div className="mb-6 space-y-4">
              ...
              <div className="flex justify-between">
                <span className="text-muted-foreground">Fatura Dönemi:</span>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                * Bu tutar otomatik olarak kartınızdan çekilecektir.
              </p>
            </div>
          </Card>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                {createSubscriptionMutation.isPending ? (
                  ...
                  `${finalPrice} ${selectedPlan.currency} Öde`
                )}
              </Button>
            </form>
          </Card>
