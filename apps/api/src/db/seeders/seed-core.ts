...
const SUBSCRIPTION_PLANS = [
  {
    id: "plan-free-yearly",
    name: "Keşif Planı",
    description: "Yeni başlayan işletmeler için ücretsiz yıllık keşif paketi",
    price: 0,
    ...
    entitlements: [
      ...
      { resourceKey: "place.bungalow_tiny_house", limitCount: 1 },
      { resourceKey: "place.hotel_pension", limitCount: 1 },
      { resourceKey: "place.detached_house_apartment", limitCount: 1 },
      { resourceKey: "place.camp_site", limitCount: 1 },
      { resourceKey: "place.transfer", limitCount: 1 },
      { resourceKey: "place.boat_tour", limitCount: 1 },
      { resourceKey: "place.paragliding_microlight_skydiving", limitCount: 1 },
      { resourceKey: "place.safari", limitCount: 1 },
      { resourceKey: "place.water_sports", limitCount: 1 },
      { resourceKey: "place.ski", limitCount: 1 },
      { resourceKey: "place.balloon_tour", limitCount: 1 },
      { resourceKey: "blog.post", limitCount: 0 },
  ...
  },
  {
    ...
    name: "Gelişim Planı",
    description: "Büyümeyi hedefleyen işletmeler için yıllık plan",
    price: 11990,
    currency: "TRY" as const,
    billingCycle: "yearly" as const,
    active: true,
    ...
    entitlements: [
      ...
      { resourceKey: "place.bungalow_tiny_house", limitCount: 5 },
      { resourceKey: "place.hotel_pension", limitCount: 5 },
      { resourceKey: "place.detached_house_apartment", limitCount: 5 },
      { resourceKey: "place.camp_site", limitCount: 5 },
      { resourceKey: "place.transfer", limitCount: 5 },
      { resourceKey: "place.boat_tour", limitCount: 5 },
      { resourceKey: "place.paragliding_microlight_skydiving", limitCount: 5 },
      { resourceKey: "place.safari", limitCount: 5 },
      { resourceKey: "place.water_sports", limitCount: 5 },
      { resourceKey: "place.ski", limitCount: 5 },
      { resourceKey: "place.balloon_tour", limitCount: 5 },
      { resourceKey: "blog.post", limitCount: 10 },
    ] as PlanEntitlementSeed[],
    features: [
      "Kategori başına 5 ilan hakkı",
  ...
  },
  {
    ...
    name: "Yükseliş Planı",
    description: "Hızlı ölçeklenen işletmeler için yıllık plan",
    price: 24990,
    currency: "TRY" as const,
    billingCycle: "yearly" as const,
    active: true,
    ...
    entitlements: [
      ...
      { resourceKey: "place.bungalow_tiny_house", limitCount: 20 },
      { resourceKey: "place.hotel_pension", limitCount: 20 },
      { resourceKey: "place.detached_house_apartment", limitCount: 20 },
      { resourceKey: "place.camp_site", limitCount: 20 },
      { resourceKey: "place.transfer", limitCount: 20 },
      { resourceKey: "place.boat_tour", limitCount: 20 },
      { resourceKey: "place.paragliding_microlight_skydiving", limitCount: 20 },
      { resourceKey: "place.safari", limitCount: 20 },
      { resourceKey: "place.water_sports", limitCount: 20 },
      { resourceKey: "place.ski", limitCount: 20 },
      { resourceKey: "place.balloon_tour", limitCount: 20 },
      { resourceKey: "blog.post", limitCount: 40 },
    ] as PlanEntitlementSeed[],
    features: [
      "Kategori başına 20 ilan hakkı",
  ...
  },
  {
    ...
    name: "Zirve Planı",
    description: "Üst segment işletmeler için yıllık premium plan",
    price: 39990,
    currency: "TRY" as const,
    billingCycle: "yearly" as const,
    active: true,
    ...
    maxBlogs: 100,
    entitlements: [
      { resourceKey: "place.villa", limitCount: 50 },
      { resourceKey: "place.bungalow_tiny_house", limitCount: 50 },
      { resourceKey: "place.hotel_pension", limitCount: 50 },
      { resourceKey: "place.detached_house_apartment", limitCount: 50 },
      { resourceKey: "place.camp_site", limitCount: 50 },
      { resourceKey: "place.transfer", limitCount: 50 },
      { resourceKey: "place.boat_tour", limitCount: 50 },
      { resourceKey: "place.paragliding_microlight_skydiving", limitCount: 50 },
      { resourceKey: "place.safari", limitCount: 50 },
      { resourceKey: "place.water_sports", limitCount: 50 },
      { resourceKey: "place.ski", limitCount: 50 },
      { resourceKey: "place.balloon_tour", limitCount: 50 },
      { resourceKey: "blog.post", limitCount: 100 },
    ] as PlanEntitlementSeed[],
    features: [
      "Kategori başına 50 ilan hakkı",
      "100 blog yazısı hakkı",
      "En yüksek görünürlük",
      "Stratejik performans raporları",
...
const PLACE_KINDS = [
  ...
  {
    id: "bungalow_tiny_house",
    name: "Bungalov & Tiny House",
    slug: "bungalov-tiny-house",
    icon: "cabin",
    description: "Bungalov ve tiny house konaklama birimleri",
    monetized: true,
    supportsRooms: false,
    supportsMenu: false,
    supportsPackages: false,
  ...
  {
    id: "detached_house_apartment",
    name: "Müstakil Ev & Daire",
    slug: "mustakil-ev-daire",
    icon: "apartment",
    description: "Müstakil ev ve daire konaklamaları",
    monetized: true,
    supportsRooms: false,
    supportsMenu: false,
    supportsPackages: false,
  ...
  },
  {
    ...
    description: "Transfer ve ulaşım hizmetleri",
    monetized: true,
    supportsRooms: false,
    supportsMenu: false,
  ...
  },
  {
    ...
    description: "Tekne ve mavi tur etkinlikleri",
    monetized: true,
    supportsRooms: false,
    supportsMenu: false,
    supportsPackages: true,
  ...
  {
    id: "paragliding_microlight_skydiving",
    name: "Paraşüt & Microlight & Skydiving",
    slug: "parasut-microlight-skydiving",
    icon: "paragliding",
    description: "Hava sporları ve paraşüt aktiviteleri",
    monetized: true,
    supportsRooms: false,
    supportsMenu: false,
    supportsPackages: true,
  ...
  },
  {
    ...
    slug: "safari",
    icon: "hiking",
    description: "Safari ve arazi turu deneyimleri",
    monetized: true,
    supportsRooms: false,
    supportsMenu: false,
    supportsPackages: true,
  ...
  },
  {
    ...
    slug: "su-sporlari",
    icon: "surfing",
    description: "Su sporları ve deniz aktiviteleri",
    monetized: true,
    supportsRooms: false,
    supportsMenu: false,
    supportsPackages: true,
  ...
  },
  {
    ...
    description: "Kayak ve kış sporu etkinlikleri",
    monetized: true,
    supportsRooms: false,
    supportsMenu: false,
    supportsPackages: true,
  ...
  },
  {
    ...
    description: "Balon turu deneyimleri",
    monetized: true,
    supportsRooms: false,
    supportsMenu: false,
    supportsPackages: true,
