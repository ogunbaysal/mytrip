...
const buildDefaultEntitlements = (
  ...
  { resourceKey: "place.bungalow_tiny_house", limitCount: maxPlaces, isUnlimited: false },
  { resourceKey: "place.hotel_pension", limitCount: maxPlaces, isUnlimited: false },
  { resourceKey: "place.detached_house_apartment", limitCount: maxPlaces, isUnlimited: false },
  { resourceKey: "place.camp_site", limitCount: maxPlaces, isUnlimited: false },
  { resourceKey: "place.transfer", limitCount: maxPlaces, isUnlimited: false },
  { resourceKey: "place.boat_tour", limitCount: maxPlaces, isUnlimited: false },
  {
    resourceKey: "place.paragliding_microlight_skydiving",
    limitCount: maxPlaces,
    isUnlimited: false,
  },
  { resourceKey: "place.safari", limitCount: maxPlaces, isUnlimited: false },
  { resourceKey: "place.water_sports", limitCount: maxPlaces, isUnlimited: false },
  { resourceKey: "place.ski", limitCount: maxPlaces, isUnlimited: false },
  { resourceKey: "place.balloon_tour", limitCount: maxPlaces, isUnlimited: false },
