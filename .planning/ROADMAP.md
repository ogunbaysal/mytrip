...
### Phase 4: Lets implement forget password flow and google login flow.

**Goal:** Web users can reset their password and sign in with Google via the existing Better Auth web namespace.
...
- [ ] 04-01: Configure web auth for password reset + Google provider
- [ ] 04-02: Add forgot/reset password pages and Google login entry points
